...
import "./style.css";
import "../../../public/social-media/facebook.svg"
import { Link } from "react-router-dom";
const simpleIcons = require('simple-icons');
simpleIcons.get('[ICON SLUG]');

// For example:
const facebook = simpleIcons.get('facebook');
console.log(facebook);

const linkedIn = simpleIcons.get('linkedIn');
console.log(linkedIn);

const gitHub = simpleIcons.get('gitHub');
console.log(gitHub);
